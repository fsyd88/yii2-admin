 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'fsyd\admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    //public $mainLayout = '@fsyd/admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('fsyd\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
