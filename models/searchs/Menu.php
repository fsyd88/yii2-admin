...
namespace fsyd\admin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use fsyd\admin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\fsyd\admin\models\Menu]].
 * 
