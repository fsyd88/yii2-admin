...
namespace fsyd\admin\components;
 ...
 * 
 * ```
 * use fsyd\admin\components\MenuHelper;
...
class MenuHelper {
     ...
     * @return array
     */
    public static function getAssignedMenu($userId, $root = null, $callback = 'self::menuCallback', $refresh = false) {
    ...
    protected static function menuCallback($menu) {
