...
use <?= $generator->indexWidgetType === 'grid' ? "fsyd\\admin\\widgets\\GridView" : "yii\\widgets\\ListView" ?>;
...
<div class="box">
    <div class="box-header with-border">                 
        ...
        <?php if (!empty($generator->searchModelClass)): ?>
            <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#filter-modal">
